    ...
    <div className="bg-slate-300 text-slate-800 px-6 py-4 rounded-lg shadow-xl sm:py-8">
      <form onSubmit={signInFormHandler}>
        ...
        <div className="mb-2 sm:mb-4">
          <a className="text-sm sm:text-base" href="#">Forgot password?</a>
        </div>
        <div className="flex justify-center items-center mb-2 sm:mb-4">
          <button className="bg-black text-white px-2 py-2 w-full rounded-md transition-all hover:bg-gray-800 sm:py-3 sm:px-3" disabled={loading}>Sign In</button>
        </div>
        <div className="flex justify-center items-center mb-2 sm:mb-4">
          <p>OR</p>
        </div>
      ...
      <div className="flex items-center justify-center mb-4">
        <div className="cursor-pointer w-full">
          <button
            className="px-2 py-2 w-full rounded-md ring-1 ring-black flex justify-center items-center gap-1 sm:px-3 sm:py-3"
            onClick={googlePopupSignInHandler}
          >
      ...
      <div className="flex items-center justify-center gap-2 mb-2 sm:mb-4">
        ...
        <Link className="text-sm text-black hover:underline" to="/signup">Sign Up</Link>
      </div>
